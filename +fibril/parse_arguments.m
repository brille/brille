...
%              fibril.parse_arguments (args, keyval_def)
%
% Specify the number of required parameters and number of optional parameters:
%   >> [...] = fibril.parse_arguments (args, npar_req, npar_opt, keyval_def)
%
...
%                          If not all arguments are passed to fibril.parse_arguments
%                          then if an error is found at the third position
%                          in args, the error message that fibril.parse_arguments
...
%
%       % Parse input:
%       [par, keyval, present] = fibril.parse_arguments...
...
%
%       % Parse input:
%       [par,argout,present] = fibril.parse_arguments(varargin,...

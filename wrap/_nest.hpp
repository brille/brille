...
void declare_bznestq(py::module &m, const std::string &typestr){
  ...
  cls.def(py::init<BrillouinZone,double,ind_t>(), py::call_guard<py::gil_scoped_release>(), "brillouin_zone"_a, "max_volume"_a, "max_branchings"_a=5);
  cls.def(py::init<BrillouinZone,ind_t,ind_t>(), py::call_guard<py::gil_scoped_release>(), "brillouin_zone"_a, "number_density"_a, "max_branchings"_a=5);

...
if bound_spec is not None:
    try:
        ...
        __all__ = ['__version__', 'version', 'AngleUnit', 'LengthUnit', 'Bravais', 'RotatesLike', 'NodeType',
                   'real_space_tolerance', 'reciprocal_space_tolerance', 'ApproxConfig', 'Basis', 'HallSymbol',
                   'Spacegroup', 'Pointgroup', 'Symmetry', 'PointSymmetry', 'PrimitiveTransform', 'BrillouinZone',
                   'Polyhedron', 'LPolyhedron', 'SortingStatus', 'BZTrellisQcc', 'BZTrellisQdc', 'BZTrellisQdd',

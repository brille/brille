...
// const double           ln10 = 2.30258509299404568402;
  ...
  static const double one_thirds_pi = pi / 3.;
  static const double half_pi = std::acos(0.);
  static const double two_thirds_pi = two_pi / 3.;
  static const double half_root_two = std::sqrt(2) / 2.;
  static const double half_root_three = std::sqrt(3) / 2.;

template<class T>
static T degree_to_radian(T degree){
//  static const auto pi = std::acos<T>(-1);

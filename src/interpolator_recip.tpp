...
template<class T> 
bool
Interpolator<T>::rip_recip_vec(data_t<T>& x, const PointSymmetry& ptsym, const std::vector<size_t>& r, const std::vector<size_t>& invR, const int nthreads) const {
...
template<class T> 
bool
Interpolator<T>::rip_recip_mat(data_t<T>& x, const PointSymmetry& ptsym, const std::vector<size_t>& r, const std::vector<size_t>& invR, const int nthreads) const {

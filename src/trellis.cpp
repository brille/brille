...
*/
Trellis construct_trellis(const Polyhedron& poly, const double fraction){
  double full_volume = poly.volume();
  double node_volume = ((fraction> 0. && fraction<1.) ? fraction : 1.)*full_volume;
